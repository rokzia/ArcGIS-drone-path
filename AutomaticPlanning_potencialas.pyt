...
class Tool:
    ...
    def execute(self, parameters, messages):
        ...
        path = theta_star(radarValues, startIndexes, endIndexes, weight, self.resolution, (self.radar.extent.XMin, self.radar.extent.YMax))
...
def theta_star(grid, start, end, weight, resolution, origin):
